...
public class X86_64 {
  ...
  /** append a new instruction to the code */
  ...
  /**
   * append code to the text zone
   * (e.g. too add primitives written in assembly)
   */
  ...
  /** add a label to the data segment */
